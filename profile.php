        ...
        <div class="content">
            ...
            <div class="content-2">
                <div class="recent-payments">
                    <div class="title">
                        <h2>Profile Page</h2>
                        <li><a href="home.php"><button class="btn" id="addBtn">Back to Home</button></a></li>
                        <li><a href=""><button class="btn" id="addBtn">Print page</button></a></li>
