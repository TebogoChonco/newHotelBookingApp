...
<body>
  <div class="side-menu">
    ...
    <li><a href="hotels.php"><img src="./assets/images/reading-book (1).png" alt="">&nbsp;<span>Hotels</span></a></li>
    <!-- <li><a href="brands.php"><img src="./assets/images/teacher2.png" alt="">&nbsp;<span>Brands</span></a></li> -->
    <li><a href="bookings.php"><img src="./assets/images/school.png" alt="">&nbsp;<span>Bookings</span></a></li>
